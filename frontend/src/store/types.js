...
export const STORE_COLLECTION_SET = 'set all stores'
export const STORE_SETUP_BEGIN = 'store setup begin';
export const STORE_SETUP_SUCCESS = 'store setup ok';
export const STORE_SETUP_FAILURE = 'store setup fail';
export const STORE_UPDATE_BEGIN = 'store update begin';
export const STORE_UPDATE_SUCCESS = 'store update ok';
export const STORE_UPDATE_FAILURE = 'store update failed';
export const STORE_CREATE_BEGIN = 'store create begin';
export const STORE_CREATE_SUCCESS = 'store creation ok';
export const STORE_CREATE_FAILURE = 'store creation failed';

export const TOKEN_COLLECTION_SET = 'set all tokens';
export const TOKEN_SETUP_BEGIN = 'token setup begin';
export const TOKEN_SETUP_SUCCESS = 'token setup ok';
export const TOKEN_SETUP_FAILURE = 'token setup failed';
