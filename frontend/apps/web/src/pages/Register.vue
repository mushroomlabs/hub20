...
<card class="registration-screen" title="Create Account">
  <slot>
    ...
    <form v-if="!registrationLoading && !registrationCompleted" @submit.prevent="signUp(inputs)">
      <fg-input v-model="inputs.username"
                type="text" id="username" placeholder="username" autocomplete="username"
                required />
      <fg-input v-model="inputs.password1"
                type="password" id="password1" placeholder="password" autocomplete="new-password"
                required />
      <fg-input v-model="inputs.password2"
                type="password" id="password2" placeholder="confirm password" autocomplete="new-password"
                required />
