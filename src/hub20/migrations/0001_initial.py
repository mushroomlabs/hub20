# Generated by Django 2.2.8 on 2019-12-09 15:53
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "amount",
                    ethereum_money.models.EthereumTokenAmountField(
            ...
            fields=[
                ...
                (
                    ...
                    models.BigIntegerField(
                        default=hub20.models.payments.generate_payment_order_id, unique=True
                    ),
                ),
                (
                    "order",
                    models.OneToOneField(
                        ...
                        to="hub20.PaymentOrder",
                    ),
                ),
                (
                    "raiden",
                    models.ForeignKey(
                        null=True, on_delete=django.db.models.deletion.SET_NULL, to="raiden.Raiden"
                    ),
                ),
                (
                    "wallet",
                    models.OneToOneField(
                        on_delete=django.db.models.deletion.CASCADE, to="hub20.Wallet"
                    ),
                ),
            ],
            options={"abstract": False,},
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "order",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.PROTECT, to="hub20.PaymentOrder"
                    ),
                ),
            ],
            options={"abstract": False,},
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "transaction_hash",
                    gnosis.eth.django.models.HexField(db_index=True, max_length=64, unique=True),
                ),
                (
                    "transfer",
                    models.OneToOneField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "raiden",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.PROTECT, to="raiden.Raiden"
                    ),
                ),
            ],
            options={"abstract": False,},
        ...
        migrations.CreateModel(
            ...
            options={"get_latest_by": "created", "unique_together": {("order", "status")},},
        ),
        migrations.CreateModel(
