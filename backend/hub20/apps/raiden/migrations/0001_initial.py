...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='Raiden',
            fields=[
                ('keystoreaccount_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='ethereum_money.KeystoreAccount')),
                ('url', models.URLField(default='http://localhost:5001', help_text='Root URL of server (without api/v1)')),
